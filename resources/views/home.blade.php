                ...
                <div class="card mb-4 progress-banner">
                    <div class="card-body text-center justify-content-between d-flex flex-row align-items-center">
                        <div class="card-body text-center">
                            ...
                            <div>
                                <p class="lead text-white"><span style="font-family: 'Tajawal', sans-serif">عدد الاتصالات الداخلية</span> {{\App\Models\Contact::getContact()}} </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4 progress-banner">
                    <div class="card-body text-center justify-content-between d-flex flex-row align-items-center">
                        <div class="card-body text-center">
                            <i class="simple-icon-arrow-up-circle mr-2 text-white align-text-bottom d-inline-block"></i>
                            <div>
                                <p class="lead text-white"><span style="font-family: 'Tajawal', sans-serif">عدد طلبات العمل</span> {{\App\Models\Contact::getContactTwo()}} </p>
                            </div>
                        </div>
                    </div>
                </div>
